...
public class AllBills extends javax.swing.JFrame {
   ...
   DefaultTableModel dtm = new DefaultTableModel();
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(region, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(28, 28, 28)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ArrayList<Item> items = d.getAllBills(Region);
        Object[] RowItem = new Object[2];
        int con =0;
        for(int i=0; i<items.size() ; i++)
        {
            RowItem[0]=items.get(i).getmetercode();
            RowItem[1]=items.get(i).getbill();
            dtm.addRow(RowItem);
            con = 1;
        }
        if(con==0)
