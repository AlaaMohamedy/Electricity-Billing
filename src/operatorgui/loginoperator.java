...
public class loginoperator extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       Operator login = new Operator();
        String un = this.name.getText().toString();
        String pass = this.jPasswordField1.getText().toString();
        if (login.login(un, pass) == true) {
            JOptionPane.showMessageDialog(null, "Welcome " + name.getText(), "Successful Login", JOptionPane.PLAIN_MESSAGE);
            new operatorchoice().setVisible(true);
        } else {
            JOptionPane.showMessageDialog(null, "Invaild username and password", "UnSuccessful Login", JOptionPane.ERROR_MESSAGE);
        }
